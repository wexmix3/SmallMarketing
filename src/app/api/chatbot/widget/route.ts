 ...
 * Chatbot Widget API
 *
 * This API endpoint serves the chatbot widget JavaScript file.
 * It allows businesses to embed the chatbot on their websites.
 */
...
export async function GET(request: NextRequest) {
  ...
  return new NextResponse(widgetJs, { headers });
}
