...
export default function PlatformComparison({ platforms }: PlatformComparisonProps) {
  ...
  const getGrowthIndicator = (growth: string) => {
    ...
    return <span className="text-gray-500">{growth}</span>;
  };
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {platforms.map((platform) => (
            <tr key={platform.platform} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm">{getGrowthIndicator(platform.growth)}</div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm text-gray-900">{platform.reach.toLocaleString()}</div>
              </td>
            </tr>
          ))}
        </tbody>
